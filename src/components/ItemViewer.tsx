...
function SwordPlaceholder({ weaponType = "sword" }: { weaponType?: string }) {
  ...
  if (SHAPES[weaponType]) return <Float speed={1.5} rotationIntensity={0.3} floatIntensity={0.4}>{SHAPES[weaponType]}</Float>;
