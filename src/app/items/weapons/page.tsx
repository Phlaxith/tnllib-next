      ...
      {WEAPON_MODELS.length === 0 ? (
        <div className="flex-1 flex flex-col items-center justify-center gap-4 rounded-2xl border"
          ...
          <div className="text-center">
            <div className="font-semibold mb-1" style={{ color: "var(--text-primary)" }}>No models configured</div>
            <div className="text-sm" style={{ color: "var(--text-secondary)" }}>
              Open <code className="px-1 rounded" style={{ background: "var(--bg-secondary)", color: "var(--accent-bright)" }}>src/lib/models.ts</code> and add your models to <code>WEAPON_MODELS</code>
            </div>
          </div>
        </div>
      ) : (
        ...
        >
          ...
          <div className="flex flex-col gap-2 overflow-hidden">
            ...
            <div className="text-xs shrink-0" style={{ color: "var(--text-muted)" }}>
              {filtered.length} / {WEAPON_MODELS.length} models
            </div>
