...
const SECTIONS: SectionConfig[] = [
  { key: "weapons",      href: "/weapons/bow",             Icon: Swords,     color: "var(--gold)",  badge: "WIP", title: "Weapons skills",        desc: "All skills sorted by weapon type." },
  { key: "achievements", href: "/achievements",            Icon: Trophy,     color: "var(--yellow)", badge: "Updated Nix", title: "Achievements",          desc: "The complete list of achievements with icons." },
